  ...
  list: [
    {
      ...
      startedAt: '2026-07',
      descriptions: [
        '2026.07 팀명이 Commerce Log Automation팀에서 Ads Log Automation팀으로 변경, 커머스 로그 자동화 플랫폼 운영은 병행',
        '팀 리드로서 서버 아키텍처 설계 전담, 신규 PO 및 서버 개발자 합류에 맞춘 온보딩 체계 설계',
        '광고 전환 로그 검수 PO로서 광고 프로덕트·데이터·캠페인·기기 자동화 팀과 판정 기준 수립 및 협업',
        '검수자가 기기 미러링으로 광고 퍼널을 수행하고(Human-in-the-Loop), 시스템이 추적 키로 전환 로그를 모아 자동 판정하는 구조 설계',
    ...
    },
    {
      ...
      descriptions: [
        ...
        'Flowise 기반 LLM 연동으로 AI 정답지 자동 생성, 캔버스 오토매핑, Kafka 기반 비동기 실행 구조 도입',
        '앱 로그를 넘어 결제·인증 등 서버 도메인 로그까지 검증 대상 확장, 관련 특허 2건 출원',
        '2026.05~ 광고 전환 로그 검수 PO 겸임 시작',
      ],
      skillKeywords: [
        'Kotlin',
        'Spring Boot',
